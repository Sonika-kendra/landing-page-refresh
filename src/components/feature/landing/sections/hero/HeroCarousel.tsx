...
<div className="absolute right-4 bottom-4 pointer-events-none">
  <div className="bg-secondary/80 p-6 rounded shadow-lg text-center">
...
<button
  onClick={handlePrev}
  className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/60 hover:bg-white/80 w-12 h-12 md:w-14 md:h-14 flex items-center justify-center shadow-md rounded-full z-20"
>
  ‹
</button>
<button
  onClick={handleNext}
  className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/60 hover:bg-white/80 w-12 h-12 md:w-14 md:h-14 flex items-center justify-center shadow-md rounded-full z-20"
>
  ›
</button>
