import { websiteUrlConfig } from './site';
    ...
    categories: [
      {
        ...
        links: [
          { label: 'Natural Diamonds', href: `${websiteUrlConfig.Diamonds.All}?stock_type=Natural`, image: diamondsCategory },
          { label: 'Lab-Grown Diamonds', href: `${websiteUrlConfig.Diamonds.All}?stock_type=Lab`, image: labGrownDiamond },
        ],
      },
      {
        title: 'By Shape',
        links: [
          { label: 'Round Brilliant', href: `${websiteUrlConfig.Diamonds.All}?shape=Round` },
          { label: 'Princess Cut',    href: `${websiteUrlConfig.Diamonds.All}?shape=Princess` },
          { label: 'Oval',            href: `${websiteUrlConfig.Diamonds.All}?shape=Oval` },
          { label: 'Emerald Cut',     href: `${websiteUrlConfig.Diamonds.All}?shape=Emerald` },
          { label: 'Cushion',         href: `${websiteUrlConfig.Diamonds.All}?shape=Cushion` },
          { label: 'Pear',            href: `${websiteUrlConfig.Diamonds.All}?shape=Pear` },
          { label: 'Marquise',        href: `${websiteUrlConfig.Diamonds.All}?shape=Marquise` },
          { label: 'Radiant',         href: `${websiteUrlConfig.Diamonds.All}?shape=Radiant` },
        ],
      },
      {
        title: 'By Carat',
        links: [
          { label: '0.25 - 0.50 ct', href: `${websiteUrlConfig.Diamonds.All}?carat_min=0.25&carat_max=0.5` },
          { label: '0.50 - 1.00 ct', href: `${websiteUrlConfig.Diamonds.All}?carat_min=0.5&carat_max=1` },
          { label: '1.00 - 2.00 ct', href: `${websiteUrlConfig.Diamonds.All}?carat_min=1&carat_max=2` },
          { label: '2.00+ ct',       href: `${websiteUrlConfig.Diamonds.All}?carat_min=2` },
        ],
      },
      {
        title: 'Pairs & Sets',
...
export const stats = [
  { value: '99%', label: 'Client Satisfaction', icon: Diamond },
  { value: '3,000+', label: 'Certified Stones Available', icon: Gem },
  { value: '50 Years', label: 'Trade Expertise', icon: Award },
  { value: '5,000+', label: 'Clients Worldwide', icon: Users },
];
