...
import { categories } from '@/data/landing/categories';
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-start pt-24 md:pt-26 z-20 pointer-events-none">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="opacity-100 bg-primary border-primary text-white pointer-events-auto transition-colors duration-300 hover:bg-white hover:text-accent hover:border-white [&:hover_svg]:translate-x-2"
                >
                  Shop Now
