        ...
        <div className="henig-container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-12">
            ...
            <aside className="lg:sticky lg:top-24 self-start">
                  ...
                  {recentPosts.map((p, index) => {
                    ...
                    return (
                      <motion.li key={p._id || p.id} initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.05 }}>
                        <Link to={`${websiteUrlConfig.Blogs}/${p.id}${p.params || ''}`} className="group flex gap-3 items-start">
              ...
              <Link to={websiteUrlConfig.Blogs} className="inline-flex items-center gap-1 text-primary text-sm mt-6 font-medium hover:underline">
